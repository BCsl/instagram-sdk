 ...
 */
class InstagramAPIException internal constructor(val statusCode: Int, val statusMessage: String, override val cause: Throwable? = null) : Exception(buildMessage(statusCode, statusMessage), cause) {
